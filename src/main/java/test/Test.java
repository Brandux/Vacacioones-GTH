...
import pe.edu.upeu.mavenspring.config.AppConfig;
import pe.edu.upeu.mavenspring.dao.PrestamoDAO;

import pe.edu.upeu.mavenspring.dao.ReservaDAO;
...
Valida();
    ...
    public static void Valida()
    {
        ...
        if (u != null){
            System.out.println("si");
            System.out.println(u.getUs_apellidos());
        }else {
            System.out.println("no");
        }
    }
