<%-- 
    Document   : Producto
    Created on : 02/07/2017, 06:19:28 PM
    Author     : Brandukosky
--%>
        ...
        <div class="container" style="width: 650px;">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <hr>
                    <h3><i class="fa fa-sitemap" aria-hidden="true" style="color: #cccc00"></i><strong style="margin-left: 5px;">Productos</strong></h3>
                    <hr> 
                    <br>
            ...
            <table class="table">
                ...
                <tbody id="tablita">
                    ...
                    <c:forEach var="prod" items="${prod}" varStatus="status">
                        ...
                        <td>
                        <td><button onclick="" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                            <button onclick="" class="btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i></button></td>
                        </td> 
                    </tr>
                    </c:forEach> 
                </tbody>
