        ...
        return jt.query(sql, new ResultSetExtractor<UsuarioDTO>() {
            ...
            public UsuarioDTO extractData(ResultSet rs) throws SQLException,
                ...
                if (rs.next()) {
                    ...
                    c.setUs_id(rs.getInt("US_ID"));
                    c.setUs_nombres(rs.getString("US_NOMBRES"));
                    c.setUs_apellidos(rs.getString("US_APELLIDOS"));
                    c.setUs_user(rs.getString("US_USER"));
                    c.setUs_clave(rs.getString("US_CLAVE"));
                    c.setUs_dni(rs.getString("US_DNI"));
                    c.setUs_celular(rs.getString("US_CELULAR"));
                    return c;
                }
                return null;
            }
